...
public class CompaniesProducer {
    ...
    public static Set<Company> createCompanies() {
        ...
        companies.add(new Company.CompanyBuilder().fullName("Facebook").code("FB").price(5.5554).changeToUp(false).build());
        companies.add(new Company.CompanyBuilder().fullName("Ebay").code("EB").price(5.5554).changeToUp(false).build());
